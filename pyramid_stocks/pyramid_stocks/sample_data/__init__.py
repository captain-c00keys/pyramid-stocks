MOCK_DATA = [
    ...
    "website": "www.eqt.com",
    "description": "EQT Corp. focuses on natural gas production, gathering and transmission in the Appalachian area. It operates its business through the following segments: EQT Production, EQT Gathering and EQT Transmission. The EQT Production segment engages in the exploration, development and production of natural gas, natural gas liquids and crude oil. The EQT Gathering segment contains the Company's gathering assets that are included in EQM. The EQT Transmission segment includes the company's FERC-regulated interstate pipeline and storage operations. The company was founded in 1888 and is headquartered in Pittsburgh, PA.",
    "CEO": "David Porges",
    "issueType": "cs",
    ...
    "description": "Regeneron Pharmaceuticals, Inc. operates as a biopharmaceutical company, which engages in inventing medicines for people with serious diseases. It includes Arcalyst, Dupixent, Eylea, Kevzara, and Praluent injections. The company was founded by Alferd G. Gilman, Leonard S. Schleifer, and Eric M. Shooter on January 8, 1988 and is headquartered in Tarrytown, NY.",
